 ...
 * @author JAGTAP
 */
public class LabManageUserAccountJPanel extends javax.swing.JPanel {

    /**
     * Creates new form LabManageUserAccountJPanel
     */
    private JPanel container;
    private Enterprise enterprise;
    public LabManageUserAccountJPanel(JPanel container, Enterprise enterprise) {
        initComponents();
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        if(EcoSystem.checkIfUsernameIsUnique(userName)){
            ...
            //        else{
                ...
                //        }
            if (organization instanceof LabAssistantOrganization){
                LabAssistant s= (LabAssistant)employee.getP();

                //s.setName(employee.getName());
                ((LabAssistantOrganization) organization).getListOfLabAssistants().add(s);
