...
import Business.Role.InsuranceInventaryManagerRole;
 ...
 * @author kruti
 */
public class InsuranceManageUserAccountJPanel extends javax.swing.JPanel {

    /**
     * Creates new form InsuranceManageUserAccountJPanel
     */
    private JPanel container;
    private Enterprise enterprise;
    public InsuranceManageUserAccountJPanel(JPanel container, Enterprise enterprise) {
        initComponents();
    ...
    private void populateRoleComboBox(Enterprise e){
        ...
        if(organization instanceof InsuranceManagerOrganization){
       // for (Role role : e.getSupportedRole()){
            roleJComboBox.addItem(new InsuranceInventaryManagerRole());
        }
    }   
    public void popData() {
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        if(EcoSystem.checkIfUsernameIsUnique(userName)){
            ...
            //        else{
                ...
                //        }
            if (organization instanceof InsuranceManagerOrganization){
                InsuranceInventoryManager s= (InsuranceInventoryManager)employee.getP();

                //s.setName(employee.getName());
                ((InsuranceManagerOrganization) organization).getListOfInsuranceInventoryManager().add(s);
